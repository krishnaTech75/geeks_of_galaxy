      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">NASA-Powered Agricultural Intelligence</p>
          </div>
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleLogin}>
                ...
                <div className="mt-4 text-center text-sm">
                  ...
                  <Link href="/auth/signup" className="underline underline-offset-4 text-green-600">
                    Sign up
                  </Link>
                </div>
              </form>
